		...
		<Layout>
			...
			<div>
				...
				<div className="pb-5 pt-3">
					<h4>9:30, 25 August, 2023</h4>
					<h5>Uhr Standesamt, Lotharinger Kloster, Hörsterstraße 28, 48143 Münster</h5>
				</div>

				<div>
					<h4>12:00, 25 August, 2023</h4>
					<h5>Uhr BBQ und Kuchen, Pieser's Gasthaus seit 1589, Grevener Straße 125, 48291 Telgte-Vadrup</h5>
				</div>
			</div>
    </Layout>
	);
